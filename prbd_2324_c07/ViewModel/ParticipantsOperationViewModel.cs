...
namespace prbd_2324_c07.ViewModel
{
    public class ParticipantsOperationViewModel : ViewModelBase<User,PridContext>
    {
        ...
        protected override void OnRefreshData() {
            ...
            var operationParticipantCards = new ObservableCollectionFast<OperationParticipantCardViewModel>(ListUsers.Select(user => new OperationParticipantCardViewModel(user)));
